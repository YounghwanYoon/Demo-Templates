...
import com.ray.sqlitetemplate.mvc_login.DatabaseController
...
class
MyArrayAdapter(context: Context, private val resource:Int, users:ArrayList<Pair<Long, UserData>>, val db: DatabaseController):ArrayAdapter<Pair<Long, UserData>>(context, resource, users){
